TASK = "Train a generative model for both unconditional image generation and class-conditional generation. Diffusion-related or flow-related models are preferred."
